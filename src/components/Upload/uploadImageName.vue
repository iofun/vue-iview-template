...
export default {
  ...
  methods: {
    ...
    uploadSuccess(response, file, fileList) {
      ...
      this.$emit('upload-image-success', this.uploadImgUrl, this.uploadImgType, this.uploadImgIdx, this.uploadImgName);
    ...
    handleRemove() {
      // this.uploadImgUrl="";
      this.$emit('upload-image-success', '', this.uploadImgType, this.uploadImgIdx, this.uploadImgName);
      // this.defaultImg=""
    },
    // 预览大图
    handleView() {
